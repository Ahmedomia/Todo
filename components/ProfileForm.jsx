      ...
      >
        ...
        <div className="flex flex-col justify-center mt-6 gap-3">
          <>
            ...
            <LogOutButton 
              className="w-full flex items-center justify-center text-red-600 border border-gray-400 py-2 rounded-xl cursor-pointer text-center hover:bg-gray-400 transition gap-2"
              onClick={onClose}
            >
              Log Out
            </LogOutButton>
